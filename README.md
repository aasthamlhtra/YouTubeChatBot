...
A powerful Retrieval-Augmented Generation (RAG) chatbot that allows you to have intelligent conversations about YouTube videos. The assistant fetches video transcripts, generates summaries, and answers questions based on the video content with source attribution and timestamps.
Features
...
bashstreamlit run chatbot_ui.py

Open your browser and navigate to the provided local URL (typically http://localhost:8501)
Enter a YouTube video ID in the input field (e.g., dQw4w9WgXcQ)
...
Error Handling
Graceful handling of various scenarios including:
